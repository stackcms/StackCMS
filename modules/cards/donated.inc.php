<?php
/**********************************************
 * Module:			Donated Decks
 * Description:		Shows list of donated decks
 */
...
$sql = $database->query("SELECT * FROM `tcg_donations` WHERE `deck_type`='Donations' ORDER BY `deck_filename` ASC");

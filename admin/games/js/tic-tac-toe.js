...
function check()
{
	...
	{
		alert("You Win!")
		document.location="/games.php?play=tic-tac-toe&go=prize"; 
		reset()
	}
...
function check2()
{
	...
	{
		alert("You Lose!")
		document.location="/games.php?play=tic-tac-toe&go=lost"; 
		reset()
	}
...
function drawCheck()
{
	...
	if( moveCount == 9 )
	{
		reset()
		alert("Draw")
		document.location="/games.php?play=tic-tac-toe&go=draw"; 
	}
}

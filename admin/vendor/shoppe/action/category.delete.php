<?php
/*********************************************************
 * Action:			Delete Shop Category
 * Description:		Show page for deleting a shop category
 */
...
{
	echo '<h1>Delete a Shop Category</h1>
	<center>';
	if( isset( $error ) )
	{
	...
	<p>Are you sure you want to delete this shop category? <b>This action can not be undone!</b><br />
	Click on the button below to delete the shop category:<br />
	<input type="submit" name="delete" class="btn btn-danger" value="Delete this category"></p>
	</form>';
}
?>
...
<p>&raquo; Do you want to <a href="'.$tcgurl.'admin/content.php?mod='.$mod.'&action=add">add an update</a>?</p>
...
while( $row = mysqli_fetch_array( $sql ) )
{
	...
	<td align="center">
		<button type="button" onClick="window.location.href=\''.$tcgurl.'admin/content.php?mod='.$mod.'&action=edit&id='.$id.'\';" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Edit this post" /><i class="bi-gear" role="image"></i></button> 
		<button type="button" onClick="window.location.href=\''.$tcgurl.'admin/content.php?mod='.$mod.'&action=delete&id='.$id.'\';" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete this post" /><i class="bi-trash3" role="image"></i></button>
	</td>
	</tr>';
}

...
if( isset( $_POST['delete'] ) )
{
	...
	{
		$success[] = "The card deck was successfully deleted.";
	}
}
...
// Show delete a deck form
	...
	<input type="submit" name="delete" class="btn btn-danger" value="Delete deck">
	</form>';
}
?>
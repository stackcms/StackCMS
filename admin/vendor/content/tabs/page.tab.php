...
<p>&raquo; Do you want to <a href="'.$tcgurl.'admin/content.php?mod=pages&action=add">add a page</a>?</p>
...
<form method="post" action="'.$tcgurl.'admin/content.php?mod=pages">
...
while( $row = mysqli_fetch_array( $sql ) )
{
	...
	<td align="center">
		<button type="button" onClick="window.location.href=\''.$tcgurl.'admin/content.php?mod=page&action=edit&id='.$id.'\';" class="btn btn-success" data-toggle="tooltip" data-placement="bottom" title="Edit this page"><i class="bi-gear" role="image"></i></button> 
		<button type="button" onClick="window.location.href=\''.$tcgurl.'admin/content.php?mod=page&action=delete&id='.$id.'\';" class="btn btn-danger" data-toggle="tooltip" data-placement="bottom" title="Delete this page"><i class="bi-trash3" role="image"></i></button>
	</td>
	</tr>';
}

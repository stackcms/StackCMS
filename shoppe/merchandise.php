...
/************************************************************************
 * Catalog:				Merchandise
 * Description:			Show full page and form processing of merchandise
 */
...
if( $general->getItem( 'itm_merchandise' ) == "None" || $general->getItem( 'itm_merchandise' ) == "" )
{
	if( $amount < 2 ) {
		// Log text
...
$database->query("UPDATE `user_items` SET `itm_currency`='$total', `itm_merchandise`='$items' WHERE `itm_name`='$player'");
?>